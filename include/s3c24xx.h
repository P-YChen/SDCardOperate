...
#define SDIPRE		(*(volatile unsigned *)0x5a000004) // sdi baud rate
#define SDICmdArg		(*(volatile unsigned *)0x5a000008) // sdi command argument
#define SDICmdCon		(*(volatile unsigned *)0x5a00000c) // sdi command control
#define SDICmdSta		(*(volatile unsigned *)0x5a000010) // sdi command status
...
#define SDIBSize		(*(volatile unsigned *)0x5a000028) // sdi bolck size
#define SDIDatCon		(*(volatile unsigned *)0x5a00002c) // sdi data control
#define SDIDatCnt		(*(volatile unsigned *)0x5a000030) // sdi data remain counter
#define SDIDatSta		(*(volatile unsigned *)0x5a000034) // sdi data status
#define SDIFSTA		(*(volatile unsigned *)0x5a000038) // sdi fifo status
#define SDIIntMsk		(*(volatile unsigned *)0x5a00003c) // sdi interrupt mask
...
#define SDICMDCON_COMMAND_DEFAULT	(1<<6)
