...
#define SDIPRE		(*(volatile unsigned long*)0x5a000004) // sdi baud rate
#define SDICmdArg		(*(volatile unsigned long*)0x5a000008) // sdi command argument
#define SDICmdCon		(*(volatile unsigned long*)0x5a00000c) // sdi command control
#define SDICmdSta		(*(volatile unsigned long*)0x5a000010) // sdi command status
...
#define SDIBSize		(*(volatile unsigned long*)0x5a000028) // sdi bolck size
#define SDIDatCon		(*(volatile unsigned long*)0x5a00002c) // sdi data control
#define SDIDatCnt		(*(volatile unsigned long*)0x5a000030) // sdi data remain counter
#define SDIDatSta		(*(volatile unsigned long*)0x5a000034) // sdi data status
#define SDIFSTA		(*(volatile unsigned long*)0x5a000038) // sdi fifo status
#define SDIIntMsk		(*(volatile unsigned long*)0x5a00003c) // sdi interrupt mask
...
#define SDICMDCON_COMMAND_DEFAULT	(1<<6) | (1<<8) //Start send & 01 header
#define SDICMDCON_COMMAND_WAITRSP	(1<<9)
#define SDICMDCON_COMMAND_LONGRSP	(1<<10)

#define SDI_FLAG_RSP	(0x01)
#define SDI_FLAG_RSP_LONG	(0x02)